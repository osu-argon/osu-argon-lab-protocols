...
1. Wipe down all surfaces, collection cups, funnel, and track with ethanol.
2. Take extra care in wiping down the gap between the magnetic where the track is installed. There can be grains stuck to the surface of the magnet.
3. Check the settings on the power supply and the vibration control unit. Be sure all dials are in the ‘off’ position.
